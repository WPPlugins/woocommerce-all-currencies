...
class WC_All_Currencies_Settings_List {
	...
	function get_settings() {
		...
		$settings[] = array(
			...
			'desc'  => __( 'You will need <a href="http://coder.fm/item/woocommerce-all-currencies/">All Currencies for WooCommerce Pro</a> to change values.', 'woocommerce-all-currencies' ),
			'type'  => 'title',
		...
		foreach ( $settings as $section ) {
			if ( isset( $section['id'] ) && 'woocommerce_currency_pos' == $section['id'] ) {
				$updated_settings[] = array(
					...
					'desc'     => __( 'You will need <a href="http://coder.fm/item/woocommerce-all-currencies/">All Currencies for WooCommerce Pro</a> to change value.', 'woocommerce-all-currencies' ),
