...
This plugin extends the WooCommerce e-commerce plugin by adding all world currencies. There is also an option for hiding currency symbol from frontend. WordPress Multisite compatible.
...
= More =
* Visit the *All Currencies for WooCommerce* plugin page at http://coder.fm/item/woocommerce-all-currencies/
...
You need [All Currencies for WooCommerce Pro plugin](http://coder.fm/item/woocommerce-all-currencies/) to change these settings.
